...
const createGroup = async (req, res) => {
    try {
        ...
        // 🔥 FIX: Database එකට දාන්න කලින් අනිවාර්යයෙන්ම String එකක් කරනවා 🔥
        ...
        const newGroup = await prisma.groups.create({
            data: {
                ...
                discount_rules: finalDiscountRules, // String කරපු එක යවනවා
                status: 1, 
                created_at: new Date()
            }
        });
...
// ==========================================
// INSTALLMENTS CRUD (Get, Create, Update, Delete)
// ==========================================
