...
// 🔥 FIX: updateProfile, updatePassword දෙපාරක් import වෙන එක අයින් කළා 🔥
const { init, sendContact, start, updateProfilePic, deleteProfilePic } = require('../controllers/homeController');
...
const userImgStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        cb(null, path.join(__dirname, '../public/images')); // Changed to match frontend requests
    },
    filename: function (req, file, cb) {
