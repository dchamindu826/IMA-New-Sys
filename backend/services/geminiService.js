...
// 🔥 1. Bank එකෙන් ආපු Data ටික (Database එකෙන් ගන්නවා වගේ හිතන්න) 🔥
...
const verifySlipImage = async (imagePath, expectedAmount) => {
    try {
        // ඔයාගේ Gemini API Key එක මෙතනට දෙන්න (හෝ DB එකෙන් ගන්න)
        ...
        // 🔥 2. AI හොයාගත්ත ගාන අපේ Site එකේ ගානට සමානද බලනවා 🔥
        ...
        // 🔥 3. Bank JSON Data එක්ක Compare කරනවා (8 AM ප්‍රශ්නෙට උත්තරේ) 🔥
